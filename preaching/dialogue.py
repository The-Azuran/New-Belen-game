...
OBJECTIONS: list[dict] = [
    ...
    },
    {
        ...
        "causes": [
            {
                "id": "abuse_cause",
                "weight": {"hostile": 4, "grieving": 3},
                "probe_text": "I'm sorry to hear that. Would you be willing to share what happened?",
                "reveal_text": "I was... I was hurt. By someone I trusted. I can't go back.",
                "unlocks": ["empathy", "listen", "church_hurt"],
                "interest_bonus": 5,
            },
            {
                "id": "hypocrisy_cause",
                "weight": {"cynic": 5, "intellectual": 2},
                "probe_text": "What happened, if you don't mind me asking?",
                "reveal_text": "The congregation judged my family when we needed help most.",
                "unlocks": ["empathy", "agree_imperfect", "different_approach"],
                "interest_bonus": 3,
            },
            {
                "id": "money_cause",
                "weight": {"cynic": 4, "skeptic": 2},
                "probe_text": "Bad experience how?",
                "reveal_text": "They kept asking for money. Tithing, building fund, missions... never enough.",
                "unlocks": ["no_money", "community_free", "authentic"],
                "interest_bonus": 3,
            },
        ],
    },
    {
        ...
        "causes": [
            {
                "id": "grief_cause",
                "weight": {"grieving": 5, "cynic": 2},
                "probe_text": "Was there... a specific moment when you stopped believing?",
                "reveal_text": "My daughter died three years ago. Where was God then?",
                "unlocks": ["empathy", "grieve_with", "listen"],
                "interest_bonus": 3,
            },
            {
                "id": "intellectual_cause",
                "weight": {"intellectual": 5, "skeptic": 3},
                "probe_text": "What led you to that conclusion?",
                "reveal_text": "I studied philosophy in college. The arguments just don't hold up.",
                "unlocks": ["logical_appeal", "evidence_based", "both_compatible"],
                "interest_bonus": 2,
            },
            {
                "id": "bad_church_cause",
                "weight": {"cynic": 4, "former_believer": 5},
                "probe_text": "Did something happen with a church?",
                "reveal_text": "My pastor turned out to be a fraud. Stole from everyone.",
                "unlocks": ["empathy", "different_approach", "agree_imperfect"],
                "interest_bonus": 4,
            },
        ],
    },
        ...
        "causes": [
            {
                ...
                "weight": {"cynic": 4, "hostile": 3},
                "probe_text": "Did someone specific let you down?",
                "reveal_text": "My best friend. Preached morality every Sunday, then slept with my wife.",
                "unlocks": ["empathy", "listen", "church_hurt"],
                "interest_bonus": 5,
            },
            {
                "id": "public_scandal",
                "weight": {"intellectual": 3, "skeptic": 3},
                "probe_text": "Something you witnessed, or heard about?",
                "reveal_text": "Our pastor was on the news. Embezzlement. Kids looked up to him.",
                "unlocks": ["agree_imperfect", "acknowledge_history", "different_approach"],
                "interest_bonus": 3,
            },
        ],
    },
        ...
        "causes": [
            {
                "id": "personal_loss",
                "weight": {"grieving": 5, "cynic": 2},
                "probe_text": "Is this... personal for you?",
                "reveal_text": "I watched my mother suffer for months. Praying every day. She still died.",
                "unlocks": ["empathy", "grieve_with", "listen", "mystery_acknowledge"],
                "interest_bonus": 4,
            },
            {
                "id": "world_suffering",
                "weight": {"intellectual": 5, "skeptic": 3},
                "probe_text": "What troubles you most about it?",
                "reveal_text": "Children starving. Wars. Disease. If God exists, he's either cruel or powerless.",
                "unlocks": ["humble", "mystery_acknowledge", "not_about_control"],
                "interest_bonus": 2,
            },
        ],
    },
    ...
    },
    {
        ...
        "causes": [
            {
                "id": "health_crisis",
                "weight": {"grieving": 5, "former_believer": 3},
                "probe_text": "What were you praying for?",
                "reveal_text": "My son. Cancer. I begged God every night. He's gone now.",
                "unlocks": ["empathy", "grieve_with", "listen", "silence_listen"],
                "interest_bonus": 5,
            },
            {
                "id": "life_circumstances",
                "weight": {"cynic": 4, "former_believer": 3},
                "probe_text": "That must have been hard. What were you hoping for?",
                "reveal_text": "Just... a break. Some luck. A job, a relationship, something. Anything.",
                "unlocks": ["empathy", "humble", "personal_story", "validate_feelings"],
                "interest_bonus": 3,
            },
        ],
    },
    {
        ...
        "causes": [
            {
                "id": "strict_upbringing",
                "weight": {"former_believer": 5, "hostile": 2},
                "probe_text": "What was that like for you?",
                "reveal_text": "Church three times a week. No TV, no secular music, no friends outside. I couldn't breathe.",
                "unlocks": ["empathy", "listen", "not_about_control", "no_pressure_offer"],
                "interest_bonus": 4,
            },
            {
                "id": "family_rift",
                "weight": {"hostile": 4, "grieving": 2},
                "probe_text": "That sounds difficult. Are things better now?",
                "reveal_text": "They disowned me when I stopped going. My own parents. For asking questions.",
                "unlocks": ["empathy", "listen", "church_hurt", "validate_feelings"],
                "interest_bonus": 5,
            },
        ],
    },
